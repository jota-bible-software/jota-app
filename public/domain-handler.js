...
(function() {
  ...
  const isMainDomainWithPath = hostname === MAIN_DOMAIN || hostname.endsWith('.' + MAIN_DOMAIN);
  const isSubdomain = !isMainDomainWithPath && hostname !== 'localhost' && hostname !== '127.0.0.1';
