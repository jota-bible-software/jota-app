export default {
  ...
  messageLine: {
    ...
    foundPassages: 'Pasajes encontrados:',
  ...
  settingsBookNames: {
    ...
    removeTooltipCopyTemplate: 'No se puede eliminar. La nomenclatura se utiliza en la plantilla de copia "{templateName}" para el idioma {lang}',
    saveButton: 'Guardar',
  ...
  settingsFormatTemplates: {
    ...
    removeTooltip: 'No se puede eliminar. La plantilla se usa en la plantilla de copia',
  ...
  settingsGeneral: {
    ...
    referencePickerOnStart: 'Mostrar selector de referencia al inicio',
    split: 'Dividido',
