<template>
  <q-btn :value="store.showPicker" @click="toggle" dense flat no-caps icon="icon-mat-checklist" v-close-popup
    :checked="store.showPicker" @change="(v: boolean) => store.showPicker = v" :data-tag="tags.referencePickerToggle">
