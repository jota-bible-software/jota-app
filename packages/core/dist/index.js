...
export { CANONICAL_BOOK_COUNT, Direction, Highlighter, TOTAL_BOOK_COUNT, addDays, addHighlight, bookAbbreviations, books, calculateProgress, chapterCounts, clearAllHighlights, clearColorHighlights, createParser, daysBetween, decodeHtml, encodeHtml, ensureGlobalRegex, errorMessage, escapeRegex, formatChapterCaption, formatDate, formatPassage, formatPassageComposable, formatReference, formatWithTemplate, fullEnglishBooks, fullPolishBooks, getAudioSource, getBook, getBookCount, getBookIndexFromOsis, getChapter, getChapterCount, getChapterCountForBook, getChapterVerses, getDayNumber, getExactPassageHighlight, getGlobalChapterIndex, getHighlightForVerse, getHighlights, getLang, getOsisCode, getOverlappingHighlights, getPassageVerses, getReadingForDay, getTotalChapterCount, getVerse, getVerseCount, isApocryphal, isArrayFormat, isMapFormat, isValidLocale, locale2lang, locale2region, nameSorter, normalizeLocale, normalizeWhitespace, osisBooks, osisToPassage, parseDate, parseReadings, parseReferences, patternToTemplate, removeHighlight, resolveOsisToPassages, search, searchContent, sortAndDeduplicate, toArrayFormat, toMapFormat, toggleHighlight };
