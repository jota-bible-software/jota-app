...
export default {
  ...
  settingsAppearance: {
    ...
    underlineVerseHighlight: 'Підкреслення для виокремлення віршів',
    continuousVerses: 'Відображати вірші безперервно',
  ...
  highlight: {
    ...
    translations: {
      title: 'Виокремлення перекладів',
      addTranslation: 'Додати переклад до виокремлень',
      removeTranslation: 'Видалити переклад з виокремлень',
      highlightCount: 'Кількість виокремлень',
      noTranslations: 'Поки немає включених перекладів для виокремлень. Виберіть переклад вище та натисніть Додати.',
      alreadyEnabled: 'Цей переклад вже включений для виокремлень',
      added: 'Переклад додано до виокремлень',
      removed: 'Переклад видалено з виокремлень',
      removeConfirmTitle: 'Видалити виокремлення перекладу',
      removeConfirmMessage: 'Ви впевнені, що хочете видалити виокремлення з "{title}"? Це не видалить ваші {count} виокремлень, але вони не будуть видимі, доки ви не увімкнете знову виокремлення для цього перекладу.'
    }
  }
}
