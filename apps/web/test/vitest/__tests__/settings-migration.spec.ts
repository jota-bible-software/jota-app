...
describe('settings-migration', () => {
  describe('migrateV2ToV3', () => {
    it('should correctly migrate settings from v2 to v3', () => {
      ...
      // Verify locales (includes pt-BR from fixture)
      expect(v3Settings.locales).toEqual(['en-US', 'pl-PL', 'pt-BR'])
  ...
  describe('migrateV6ToV7', () => {
    // V6 settings had highlightingEnabled in app settings - create type to test migration
    type V6AppSettings = SettingsPersist['app'] & { highlightingEnabled?: boolean }
